...
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{changepage} % Added for adjustwidth

\geometry{a4paper, margin=1in}

% Title formatting
\title{Final Year Project Management System (FYPMS) \\ System Design Document}
\author{Mubashir Hassan, Shumailla Sarfaraz, Sadia \\ Department of Computer Science \\ Namal University, Mianwali}
\date{\today}
